...
В связи с нулевым опытом и знаниями в сфере IT, ожидаю доступную и понятную информацию по каждому шагу, учитывая что я буду работать в Ubuntu 20.04

2) В какой сфере работаете сейчас?
Специалист по сопровождению в банке

3) Если в IT, то какой у вас опыт (инструменты, технологии, языки программирования)?
Ни какого опыта в IT
